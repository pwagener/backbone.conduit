 ...
 */
// Default test data
var DEFAULT_DATA_FILE = "../test/data/2008-20K.json";
...
function runTests(options, callback) {
    ...
    var ConduitCollection = require("./../src/Collection");
    promises.push(makeTestPromise(ConduitCollection, "fill", _.extend({
